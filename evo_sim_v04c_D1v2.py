...
def fitness_30(net, n_seeds=3, verbose=False):
    ...
    # D1v2: tighter apoptosis constraint (replaces D1's 3.0 threshold with 2.0)
    if net.params["egl1_sens"] > 2.0 and net.params["cell_survive"] > 2.0:
        total -= 1.0
    # D1v2: no single parameter allowed above 8.0
...
if __name__ == "__main__":
    ...
    dirs = {
        "D1v2_tighter": {"mut_rate": 0.12, "pop_size": 50},
    }
